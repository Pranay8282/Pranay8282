...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,3,5,6&height=200&section=header&text=Pranay%20Patel&fontSize=80&fontAlignY=35&animation=twinkling&fontColor=fff&desc=Full%20Stack%20Developer%20|%20ML%20Engineer%20|%20ERPNext%20Specialist&descSize=20&descAlignY=55" width="100%"/>
...
class Pranay8282:
    def __init__(self):
        ...
        self.workspaces = ["💻 Python", "⚛️ React", "🤖 TensorFlow", "📊 ERPNext"]
        
    def current_focus(self):
        return {
            "🔭 working_on": "AI-powered web applications & ML models",
            "🌱 learning": "Advanced ML architectures & Cloud-native dev",
            "💡 interests": "Clean Code, Scalable Systems, AI/ML Research",
            "🎯 goals_2026": "Master cloud technologies & contribute to OSS"
        }
    
    def say_hi(self):
        print(
            "Thanks for visiting! I'm passionate about building "
            "scalable solutions and solving complex problems. "
...
|:-----------|:-----:|:----------:|
| **Python & Django** | ![](https://geps.dev/progress/92?dangerColor=ef4444&warningColor=f59e0b&successColor=10b981) | 3+ years |
| **React & JavaScript** | ![](https://geps.dev/progress/88?dangerColor=ef4444&warningColor=f59e0b&successColor=10b981) | 2.5+ years |
| **Machine Learning** | ![](https://geps.dev/progress/85?dangerColor=ef4444&warningColor=f59e0b&successColor=10b981) | 2+ years |
| **ERPNext/Frappe** | ![](https://geps.dev/progress/90?dangerColor=ef4444&warningColor=f59e0b&successColor=10b981) | 2+ years |
| **Database Management** | ![](https://geps.dev/progress/87?dangerColor=ef4444&warningColor=f59e0b&successColor=10b981) | 3+ years |
| **REST API Design** | ![](https://geps.dev/progress/89?dangerColor=ef4444&warningColor=f59e0b&successColor=10b981) | 3+ years |
| **DevOps & Cloud** | ![](https://geps.dev/progress/78?dangerColor=ef4444&warningColor=f59e0b&successColor=10b981) | 1.5+ years |
...
<table>
  <tr>
    <td align="center" width="33%">
      ...
      <br><br>
      <sub>Complete web solutions from frontend to backend</sub>
      <br><br>
    </td>
    <td align="center" width="33%">
      <br>
      <b>🤖 ML/AI Solutions</b>
      <br><br>
      <sub>Intelligent automation and predictive models</sub>
      <br><br>
    </td>
    <td align="center" width="33%">
      <br>
      ...
      <br><br>
      <sub>Custom ERP implementations and integrations</sub>
      <br><br>
    </td>
  </tr>
  <tr>
    <td align="center" width="33%">
      ...
      <b>🌟 Open Source</b>
      <br><br>
      <sub>Contributing to community projects</sub>
      <br><br>
    </td>
    <td align="center" width="33%">
      <br>
    ...
    <td align="center" width="33%">
      ...
      <b>🎓 Mentorship</b>
      <br><br>
      <sub>Guiding aspiring developers</sub>
      <br><br>
    </td>
  </tr>
</table>
...
*Explore detailed case studies, live demos, and comprehensive documentation of my projects in Full Stack Development, Machine Learning, and ERPNext Solutions.*
...
💼 **Job Opportunities** • 🤝 **Collaboration** • 💡 **Projects** • 🎓 **Mentorship** • ☕ **Tech Talks**
